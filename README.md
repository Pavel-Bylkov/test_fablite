...
## Принятые решения для выполнения задания
 ...
 Приложения на Flask с базой данных PostgreSQL - принимающего запросы и отвечающее JSON данными:
...
- **Реализация ролей и прав доступа**: Руководитель может управлять всеми пользователями, а обычные пользователи имеют ограниченные права.
- **Логирование и мониторинг**: Внедрение системы логирования для отслеживания действий пользователей и мониторинга состояния приложения.
- **Защита от SQL-инъекций, CSRF и XSS атак**: Внедрение механизмов защиты от распространенных веб-уязвимостей.
